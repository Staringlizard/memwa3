...
#define SERV_VIDEO_MENU_WIDTH              SERV_VIDEO_SCREEN_WIDTH
#define SERV_VIDEO_MENU_HEIGHT             SERV_VIDEO_SCREEN_HEIGHT
#define SERV_VIDEO_MENU_ROWS               (SERV_VIDEO_SCREEN_HEIGHT/SERV_VIDEO_ROW_HEIGHT)
