...
tda19988_read_edid_block(struct tda19988_softc *sc, uint8_t *buf, int block)
{
    ...
    /* Block 0 */
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_DDC_ADDR, 0xa0);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_DDC_OFFS, (block % 2) ? 128 : 0);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_DDC_SEGM_ADDR, 0x60);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_DDC_SEGM, block / 2);

    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_EDID_CTRL, 1);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_EDID_CTRL, 0);
...
/*
    ...
    drv_i2c_clear_reg(TDA19988_ADDR_HDMI, TDA_INT_FLAGS_2, INT_FLAGS_2_EDID_BLK_RD);
...
static int tda19988_set_page(uint8_t page)
{
    ...
    /*result = */drv_i2c_wr_reg(TDA19988_ADDR_HDMI, addr, page);
    /*if (result)
...
static int tda19988_wr_reg2(uint8_t addr, uint16_t address, uint16_t data)
{
    uint8_t cmd[3];
    int result;
...
void tda19988_init_encoder(tda19988_vm_t *mode)
{
    ...
    drv_i2c_set_reg(TDA19988_ADDR_HDMI, TDA_TBG_CNTRL_1, TBG_CNTRL_1_DWIN_DIS);
    drv_i2c_clear_reg(TDA19988_ADDR_HDMI, TDA_HDCP_TX33, HDCP_TX33_HDMI);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_ENC_CNTRL, ENC_CNTRL_DVI_MODE);

    /* no pre-filter or interpolator */
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_HVF_CNTRL_0, HVF_CNTRL_0_INTPOL_BYPASS | HVF_CNTRL_0_PREFIL_NONE);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_VIP_CNTRL_5, VIP_CNTRL_5_SP_CNT(0));
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_VIP_CNTRL_4, VIP_CNTRL_4_BLANKIT_NDE | VIP_CNTRL_4_BLC_NONE);
    drv_i2c_clear_reg(TDA19988_ADDR_HDMI, TDA_PLL_SERIAL_3, PLL_SERIAL_3_SRL_CCIR);
    drv_i2c_clear_reg(TDA19988_ADDR_HDMI, TDA_PLL_SERIAL_1, PLL_SERIAL_1_SRL_MAN_IP);
    drv_i2c_clear_reg(TDA19988_ADDR_HDMI, TDA_PLL_SERIAL_3, PLL_SERIAL_3_SRL_DE);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_SERIALIZER, 0);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_HVF_CNTRL_1, HVF_CNTRL_1_VQR_FULL);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_RPT_CNTRL, 0);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_SEL_CLK, SEL_CLK_SEL_VRF_CLK(0) | SEL_CLK_SEL_CLK1 | SEL_CLK_ENA_SC_CLK);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_PLL_SERIAL_2, PLL_SERIAL_2_SRL_NOSC(div) | PLL_SERIAL_2_SRL_PR(0));
    drv_i2c_set_reg(TDA19988_ADDR_HDMI, TDA_MAT_CONTRL, MAT_CONTRL_MAT_BP);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_ANA_GENERAL, 0x09);
    drv_i2c_clear_reg(TDA19988_ADDR_HDMI, TDA_TBG_CNTRL_0, TBG_CNTRL_0_SYNC_MTHD);
    ...
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_VIP_CNTRL_3, reg);
    ...
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_TBG_CNTRL_1, reg);

    /* Program timing */
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_VIDFORMAT, 0x00);

    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_REFPIX_MSB, ref_pix);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_REFLINE_MSB, ref_line);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_NPIX_MSB, n_pix);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_NLINE_MSB, n_line);

    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VS_LINE_STRT_1_MSB, vs1_line_start);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VS_PIX_STRT_1_MSB, vs1_pix_start);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VS_LINE_END_1_MSB, vs1_line_end);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VS_PIX_END_1_MSB, vs1_pix_stop);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VS_LINE_STRT_2_MSB, vs2_line_start);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VS_PIX_STRT_2_MSB, vs2_pix_start);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VS_LINE_END_2_MSB, vs2_line_end);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VS_PIX_END_2_MSB, vs2_pix_stop);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_HS_PIX_START_MSB, hs_pix_start);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_HS_PIX_STOP_MSB, hs_pix_stop);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VWIN_START_1_MSB, vwin1_line_start);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VWIN_END_1_MSB, vwin1_line_end);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VWIN_START_2_MSB, vwin2_line_start);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_VWIN_END_2_MSB, vwin2_line_end);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_DE_START_MSB, de_start);
    tda19988_wr_reg2(TDA19988_ADDR_HDMI, TDA_DE_STOP_MSB, de_stop);

    if (version == TDA19988)
        drv_i2c_wr_reg(TDA19988_ADDR_HDMI, TDA_ENABLE_SPACE, 0x00);

    /* must be last register set */
    drv_i2c_clear_reg(TDA19988_ADDR_HDMI, TDA_TBG_CNTRL_0, TBG_CNTRL_0_SYNC_ONCE);
}
...
void tda19988_configure()
{
    ...
    drv_i2c_wr_reg(TDA19988_ADDR_CEC, TDA_CEC_ENAMODS, ENAMODS_RXSENS | ENAMODS_HDMI);

    HAL_Delay(200);
    data = drv_i2c_rd_reg(TDA19988_ADDR_CEC, 0xfe);

    /* Reset core */
    drv_i2c_set_reg(TDA19988_ADDR_HDMI,  TDA_SOFTRESET, 3);
    HAL_Delay(200);
    drv_i2c_clear_reg(TDA19988_ADDR_HDMI,  TDA_SOFTRESET, 3);
    HAL_Delay(200);

    /* reset transmitter: */
    drv_i2c_set_reg(TDA19988_ADDR_HDMI,  TDA_MAIN_CNTRL0, MAIN_CNTRL0_SR);
    drv_i2c_clear_reg(TDA19988_ADDR_HDMI,  TDA_MAIN_CNTRL0, MAIN_CNTRL0_SR);

    /* PLL registers common configuration */
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_PLL_SERIAL_1, 0x00);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_PLL_SERIAL_2, PLL_SERIAL_2_SRL_NOSC(1));
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_PLL_SERIAL_3, 0x00);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_SERIALIZER, 0x00);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_BUFFER_OUT, 0x00);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_PLL_SCG1, 0x00);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_SEL_CLK, SEL_CLK_SEL_CLK1 | SEL_CLK_ENA_SC_CLK);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_PLL_SCGN1, 0xfa);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_PLL_SCGN2, 0x00);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_PLL_SCGR1, 0x5b);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_PLL_SCGR2, 0x00);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_PLL_SCG2, 0x10);

    /* Write the default value MUX register */
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_MUX_VP_VIP_OUT, 0x24);

    version = 0;
    data = drv_i2c_rd_reg(TDA19988_ADDR_HDMI,  TDA_VERSION);
    version |= data;
    data = drv_i2c_rd_reg(TDA19988_ADDR_HDMI,  TDA_VERSION_MSB);
    version |= (data << 8);
    ...
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_DDC_CTRL, DDC_ENABLE);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_TX3, 39);
    drv_i2c_wr_reg(TDA19988_ADDR_CEC,  TDA_CEC_FRO_IM_CLK_CTRL,
    ...
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_VIP_CNTRL_0, 0x23);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_VIP_CNTRL_1, 0x01);
    drv_i2c_wr_reg(TDA19988_ADDR_HDMI,  TDA_VIP_CNTRL_2, 0x45);
done:
    ;  
}
