...
void led_toggle_limit_red(uint16_t value)
{
    g_red_limit = value;
}

void led_toggle_limit_green(uint16_t value)
{
    g_green_limit = value;
}

void led_toggle_limit_blue(uint16_t value)
{
    g_blue_limit = value;
}
