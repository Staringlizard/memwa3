...
#define TDA_INT_FLAGS_0                 0x000f
#define TDA_INT_FLAGS_1                 0x0010
#define TDA_INT_FLAGS_2                 0x0011
#define TDA_ENA_VP_0                    0x0018
#define TDA_ENA_VP_1                    0x0019
#define TDA_ENA_VP_2                    0x001A
...
#define TDA_CEC_RXS_HPD_INT_EN          0xfc
#define TDA_CEC_RXS_HPD_INT             0xfd
#define TDA_CEC_RXS_HPD_LEV             0xfe
#define TDA_CEC_INT_STATUS              0xee

#define DDC_ENABLE                      0
#define CCLK_ENABLE                     1
#define CTRL_EN_GLO                     (1 << 2)
...
#define CEC_RXS_HPD_INT_EN_HPD          (1 << 1)
#define CEC_RXS_HPD_INT_HPD             (1 << 1)
#define CEC_RXS_HPD_LEV_HPD             (1 << 1)
#define CEC_INT_STATUS_CEC              (1 << 0)
#define CEC_INT_STATUS_HDMI             (1 << 1)
...
void tda19988_init_encoder(tda19988_vm_t *mode)
{
    ...
    /* Mute the audio FIFO */
    set_reg_8(TDA19988_ADDR_HDMI, TDA_AIP_CNTRL, 0);
...
void tda19988_configure()
{
    ...
    /* Disable CEC HPD interrupt */
    write_reg_8(TDA19988_ADDR_CEC, TDA_CEC_RXS_HPD_INT_EN, 0);

    /* Disable global interrupts */
    write_reg_8(TDA19988_ADDR_HDMI, TDA_INT_FLAGS_0, 0);

    /* Disable EDID Block Read Interrupt */
    set_reg_8(TDA19988_ADDR_HDMI, TDA_INT_FLAGS_2, 0);

    /* Clear pending CEC irq */
    read_reg_8(TDA19988_ADDR_CEC, TDA_CEC_RXS_HPD_INT, &data);

    /* Clear pending HDMI irq */
    read_reg_8(TDA19988_ADDR_HDMI, TDA_INT_FLAGS_0, &data);
    read_reg_8(TDA19988_ADDR_HDMI, TDA_INT_FLAGS_1, &data);
    read_reg_8(TDA19988_ADDR_HDMI, TDA_INT_FLAGS_2, &data);
    ...
    /* Enable video ports */
    write_reg_8(TDA19988_ADDR_HDMI, TDA_ENA_VP_0, 0xff);
    write_reg_8(TDA19988_ADDR_HDMI, TDA_ENA_VP_1, 0xff);
    write_reg_8(TDA19988_ADDR_HDMI, TDA_ENA_VP_2, 0xff);
    ...
    write_reg_8(TDA19988_ADDR_HDMI, TDA_INT_FLAGS_0, CTRL_EN_GLO);

    /* Enable EDID Block Read Interrupt */
    set_reg_8(TDA19988_ADDR_HDMI, TDA_INT_FLAGS_2, INT_FLAGS_2_EDID_BLK_RD);

    /* Enable CEC HPD interrupt */
    write_reg_8(TDA19988_ADDR_CEC, TDA_CEC_RXS_HPD_INT_EN, CEC_RXS_HPD_INT_EN_HPD);
